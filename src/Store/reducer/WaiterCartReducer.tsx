import type { CartItem } from "../Context/WaiterCartContext"
...
// Reducer function
const WaiterCartReducer = (state: CartState, action: CartAction): CartState => {
    switch (action.type) {
        case "ADD_TO_CART": {
        ...
        case "UPDATE_QUANTITY": {
            ...
            if (quantity <= 0) {
                ...
                return WaiterCartReducer(state, { type: "REMOVE_FROM_CART", payload: { id } })
            }
...
export default WaiterCartReducer
